...
class VatStatement(models.Model):
    ...
    def _finalize_lines(self, lines):
        ...
        # calculate reverse of line 53 tax
        lines['53']['tax'] = lines['53']['tax'] * -1
        _53b = lines['53']['tax']

        # calculate reverse of line 56 - line 62
        ...
        _54b = lines['54']['tax'] + _26b + _27b + _28b + _30b + _33b + _34b\
            + _35b + _36b + _48b + _49b + _50b + _51b + _52b + _53b

        # calculate line 63
        lines['63']['tax'] = lines['63']['tax'] * 1
        _63b = lines['63']['tax'] + _54b - _56b - _57b - _58b\
            - _59b - _60b - _61b - _62b

        # calculate line 66
        lines['66']['tax'] = lines['66']['tax'] * 1
        _66b = lines['66']['tax'] + _63b + _65b

        # update lines 54, 63, 66
        lines['66'].update({'tax': _66b})
        lines['54'].update({'tax': _54b})
        lines['63'].update({'tax': _63b})
        return lines
    ...
    def _get_tags_map(self):
        ...
        return {
            ...
            config.tag_65_tax.id: ('53', 'tax'),
            config.tag_66_tax.id: ('56', 'tax'),
            config.tag_61_tax.id: ('57', 'tax'),
            config.tag_62_tax.id: ('58', 'tax'),
            config.tag_67_tax.id: ('59', 'tax'),
            config.tag_63_tax.id: ('60', 'tax'),
            config.tag_64_tax.id: ('61', 'tax'),
            config.tag_59_tax.id: ('62', 'tax'),
