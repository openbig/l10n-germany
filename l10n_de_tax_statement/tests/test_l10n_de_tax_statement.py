...
class TestVatStatement(TransactionCase):
    ...
    def setUp(self):
        ...
        self.Statement = self.env['l10n.de.tax.statement']
        self.StatLine = self.env['l10n.de.tax.statement.line']
        self.DateRange = self.env['date.range']
        self.DateRangeType = self.env['date.range.type']
        self.Config = self.env['l10n.de.tax.statement.config']
    ...
    def test_01_onchange(self):
        ...
        self.assertEqual(self.statement_1.from_date, '2017-01-01')
        self.assertEqual(self.statement_1.to_date, '2017-12-31')
    ...
    def test_09_update_working(self):
        ...
        _25 = self.StatLine.search(
            [('code', '=', '25'), ('id', 'in', self.statement_1.line_ids.ids)],
            limit=1)
        _26 = self.StatLine.search(
            [('code', '=', '26'), ('id', 'in', self.statement_1.line_ids.ids)],
            limit=1)
        ...
        self.assertFalse(_26.format_tax)
